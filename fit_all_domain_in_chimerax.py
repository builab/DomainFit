...
if __name__ == "__main__":
    ...
    for pdb in os.listdir(pdb_dir):
        if pdb.endswith((".pdb", ".cif")):
            ...
            if useMacOs == 1:
                cmds.append(f'/Applications/ChimeraX-1.5.app/Contents/MacOS/ChimeraX --nogui --offscreen --cmd \"runscript {script_dir}/fit_in_chimerax.py {pdb_dir}/{pdb} {output_dir} {input_map} {map_level} {resolution} {search}" --exit')
            else:
